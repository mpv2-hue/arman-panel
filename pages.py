# pages.py  -  Arman Panel v9.2
# شامل: LOGIN_HTML, DASHBOARD_HTML, get_public_page_html()

# لوگوی آرمان پنل (به‌صورت base64 داخلی، بدون نیاز به هاست خارجی)
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,__LOGO_B64__" alt="آرمان پنل"></div>
      <div><div class="brand-name">آرمان پنل</div><div class="brand-sub">v9.2</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="footer">آرمان پنل</div>
  </div>
</div>
<script>
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="data:image/png;base64,__LOGO_B64__" alt="آرمان پنل"></div>
    <span class="mob-title">آرمان پنل</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="data:image/png;base64,__LOGO_B64__" alt="آرمان پنل"></div>
    <div><div class="logo-name">آرمان پنل</div><div class="logo-sub">v9.2</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">آرمان پنل v9.2 · Railway</span>
  </div>
</section>
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">پشتیبانی آرمان پنل</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی با تیم آرمان پنل</div>
      </div>
    </div>
  </div>
</section>
...
<script>
let isDark=localStorage.getItem('arman-theme')!=='light';
...
function toggleTheme(){isDark=!isDark;localStorage.setItem('arman-theme',isDark?'dark':'light');applyTheme(isDark)}
applyTheme(isDark);
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,{LOGO_B64}" alt="آرمان پنل"></div>
      <div><div class="brand-name">آرمان پنل</div><div class="brand-sub">v9.2</div></div>
    </div>
  ...
  <div class="footer">آرمان پنل v9.2</div>
</div>
<script>
const UUID_KEY='{uuid_key}';
let savedPw='';

let isDark=localStorage.getItem('arman-pub-theme')!=='light';
function applyTheme(dark){{
  document.documentElement.setAttribute('data-theme',dark?'dark':'light');
  document.getElementById('theme-icon').className='ti '+(dark?'ti-sun':'ti-moon');
}}
function toggleTheme(){{isDark=!isDark;localStorage.setItem('arman-pub-theme',isDark?'dark':'light');applyTheme(isDark)}}
applyTheme(isDark);
...
function renderContent(d){{
  ...
  window._armanSubUrl  = subUrl;
  window._armanSubName = d.name;
  window._armanLinks   = d.links.map(l => ({{
    vless : l.vless_link,
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="navigator.clipboard.writeText(window._armanSubUrl).then(()=>toast('لینک ساب کپی شد ✓','ok'))">
          <i class="ti ti-copy"></i> کپی لینک ساب
        </button>
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._armanSubName + ' — کل گروه', window._armanSubUrl)">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="navigator.clipboard.writeText(window._armanLinks[${{i}}].vless).then(()=>toast('لینک کپی شد ✓','ok'))">
                  <i class="ti ti-copy"></i> کپی لینک
                </button>
                <button class="btn btn-g"
                  onclick="showQR(window._armanLinks[${{i}}].label, window._armanLinks[${{i}}].vless)">
...
function copyAllConfigs(){{
  const links=window._armanLinks||[];
